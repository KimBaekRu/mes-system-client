      ...
      >
        ...
        {isAdmin && (
          <button
            ...
            onClick={() => {
              if (window.confirm("삭제?")) onDelete(id);
            }}
          >
            X
          </button>
            ...
            {inputBlocks.map((blk, idx) => (
              ...
              >
                ...
                <input
                  ...
                  readOnly={isAdmin}
                  onChange={(e) =>
                    handleBlockChange(idx, "yieldValue", e.target.value)
                  }
                  style={{
                    width: 80,
                    height: 28,
                ...
                <input
                  ...
                  readOnly={isAdmin}
                  onChange={(e) =>
                    handleBlockChange(idx, "secondValue", e.target.value)
                  }
                  style={{
                    width: 80,
                    height: 28,
